...
description: "Paperclip MCP feedback tools: list agent feedback traces, get issue-specific traces, and retrieve full trace bundles for evaluating and improving agent behavior."
---
