...
description: "Paperclip MCP attachment tools: list, upload (base64), download, and delete file attachments on issues. Upload uses base64-encoded content with explicit MIME type."
---
