---
title: "Secrets tools — manage Paperclip encrypted secrets"
sidebarTitle: "Secrets"
description: "Paperclip MCP secret tools: list secrets by name, create encrypted credentials, update metadata, and rotate values. Board-only; values are never returned."
---
