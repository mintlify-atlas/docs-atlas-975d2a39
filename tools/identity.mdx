---
title: "Identity tools — agent identity, inbox, and sessions"
sidebarTitle: "Identity"
description: "Identity MCP tools: paperclip_get_me returns agent identity, paperclip_get_inbox lists assignments, and two board-only session management tools."
---
