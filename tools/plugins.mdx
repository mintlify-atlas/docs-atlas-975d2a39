...
description: "Paperclip MCP plugin tools: list installed plugins with status filter, inspect a plugin by key, install from npm, and enable or disable plugins."
---
