...
description: "paperclip_get_dashboard returns a company health snapshot including active goals, project status, agent workload, and recent activity. Use it for orientation on wake-up."
---
