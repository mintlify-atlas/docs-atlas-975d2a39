---
title: "Labels tools — manage issue labels in Paperclip"
sidebarTitle: "Labels"
description: "Paperclip MCP label tools: paperclip_list_labels retrieves all company labels, paperclip_create_label creates a new label with a name and hex color."
---
