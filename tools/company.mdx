...
description: "Paperclip MCP company tools: list, create, get, update, and archive company entities. The PAPERCLIP_COMPANY_ID env var scopes most other tools to a single company."
---
