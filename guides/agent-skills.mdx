...
description: "Install and use paperclip-triage-inbox, paperclip-close-epic, paperclip-audit-approvals, and paperclip-release-flow Claude Code skills for repeatable agent workflows."
---
